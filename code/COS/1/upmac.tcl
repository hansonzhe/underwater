...
add-packet-header IP Mac LL  ARP  UWVB RMAC UPMAC UPMACANN
...
puts "1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
	set node_($i) [$ns_  node $i]
puts "2xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
puts "3xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
